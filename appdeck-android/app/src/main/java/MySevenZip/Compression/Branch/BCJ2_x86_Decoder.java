...
package MySevenZip.Compression.Branch;

import MySevenZip.Common.InBuffer;
import MySevenZip.Compression.RangeCoder.BitDecoder;
import MySevenZip.Compression.RangeCoder.Decoder;
...
public class BCJ2_x86_Decoder implements ICompressCoder2 {
    ...
    MySevenZip.Compression.LZ.OutWindow _outStream = new MySevenZip.Compression.LZ.OutWindow();
