...
import MySevenZip.ICompressCoder;
import MySevenZip.ICompressGetInStreamProcessedSize;
import MySevenZip.ICompressSetDecoderProperties2;
import MySevenZip.ICompressSetInStream;
import MySevenZip.ICompressSetOutStreamSize;
import MySevenZip.ICompressProgressInfo;

import MySevenZip.Compression.RangeCoder.BitTreeDecoder;
import MySevenZip.Compression.LZ.OutWindow;
import java.io.IOException;

import MySevenZip.HRESULT;
...
/*
  ...
  #endif
 */
// OLD CODE public class Decoder implements ICompressCoder , ICompressSetDecoderProperties2
public class Decoder
        extends java.io.InputStream // _ST_MODE
        implements ICompressCoder, ICompressSetDecoderProperties2,
        ...
        
{
    class LenDecoder {
        ...
        public void Init() {
            MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(MySevenZip.Compression.RangeCoder.Decoder rangeDecoder, int posState) throws IOException {
    ...
    class LiteralDecoder {
        class Decoder2 {
            ...
            public void Init() {
                MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_Decoders);
            }
            
            public byte DecodeNormal(MySevenZip.Compression.RangeCoder.Decoder rangeDecoder) throws IOException {
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(MySevenZip.Compression.RangeCoder.Decoder rangeDecoder, byte matchByte) throws IOException {
                int symbol = 1;
                do
                {
    ...
    MySevenZip.Compression.RangeCoder.Decoder m_RangeDecoder = new MySevenZip.Compression.RangeCoder.Decoder();
    ...
    void Init() throws IOException {
        ...
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsMatchDecoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepDecoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        MySevenZip.Compression.RangeCoder.Decoder.InitBitModels(m_PosDecoders);
