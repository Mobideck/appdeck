...
import MySevenZip.Archive.Common.CoderStreamsInfo;
import MySevenZip.Compression.Branch.BCJ2_x86_Decoder;
import MySevenZip.Compression.Branch.BCJ_x86_Decoder;
import MySevenZip.HRESULT;
import MySevenZip.ICompressCoder2;
...
import MySevenZip.ICompressFilter;

import MySevenZip.Archive.Common.BindPair;
// import SevenZip.Archive.Common.CoderMixer2MT;
import MySevenZip.Archive.Common.CoderMixer2ST;
import MySevenZip.Archive.Common.CoderMixer2;
import MySevenZip.Archive.Common.FilterCoder;
            ...
            for (i = 0; i < numCoders; i++) {
                ...
                if (coderInfo.IsSimpleCoder()) {
                    ...
                    if (altCoderInfo.MethodID.equals(MethodID.k_LZMA))
                        decoder = new MySevenZip.Compression.LZMA.Decoder(); // NCompress::NLZMA::CDecoder;
                    ...
                    if (altCoderInfo.MethodID.equals(MethodID.k_Copy))
                        decoder = new MySevenZip.Compression.Copy.Decoder(); // decoder = new NCompress::CCopyCoder;
