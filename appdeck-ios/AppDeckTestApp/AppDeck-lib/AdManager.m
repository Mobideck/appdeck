...
#import "Ad/SmartAdServer/SmartAdServerAdEngine.h"
...
-(AppDeckAdEngine *)adEngineFromId:(NSString *)engineId type:(NSString *)type config:(NSDictionary *)config
{
    ...
    else if ([type isEqualToString:@"smart"])
    {
        adEngine = [[SmartAdServerAdEngine alloc] initWithAdManager:self andConfiguration:config];
    }
