...
/** *Deprecated* Gives an ad for the interstitial view to display.
 ...
 @warning Deprecated since iOS Display SDK4.5, please use addSubview.
 */

- (void)displayThisAd:(SmartAdServerAd *)adInterstitial __attribute__((availability(ios,
																					deprecated=4.5,
																					message="This method will be removed in the SAS iOS SDK 5.0 and later")));
