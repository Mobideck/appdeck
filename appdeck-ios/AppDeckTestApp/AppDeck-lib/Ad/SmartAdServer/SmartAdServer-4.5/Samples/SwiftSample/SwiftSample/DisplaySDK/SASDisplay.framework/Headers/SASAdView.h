...
#define kSASSDKVersion						@"4.4.1"
#define kSASSDKRev                          @"756e6b6e6f776e7265766973696f6e"
...
+ (void)enableTestMode __attribute__((deprecated));
...
/** Enables logging mode.
 ...
 - (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
 [SmartAdServerView setLoggingEnabled:YES];
 }
...
/** *Deprecated* Enables logging mode.
 ...
 @warning Deprecated since iOS Display SDK4.5
 */

+ (void)enableLogging __attribute__((deprecated));
...
- (void)dismiss __attribute__((deprecated));
...
//- (void)displayThisAd:(SmartAdServerAd *)adv __attribute__((deprecated));
