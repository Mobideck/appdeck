                    ...
                    entryPrefix:(NSString*)entryPrefix
{
  ...
  //CLSNSLog(@"recurseIntoDirectories: %@, %@, %@", fullPathContents, dirName, entryPrefix);
    
  NSArray *contents = [[NSFileManager defaultManager] contentsOfDirectoryAtPath:dirName error:nil];

  if (contents == nil)
  {
      NSLog(@"contentsOfDirectoryAtPath failed");
      return;
  }
    
  //CLSNSLog(@"contents: %@", contents);
