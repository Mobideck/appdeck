...
-(void)sync
{
    ...
    else
    {
        ...
        NSURLSessionDataTask *task = [session dataTaskWithRequest:[[NSMutableURLRequest alloc] initWithURL:self.url] completionHandler: ^(NSData *data, NSURLResponse *response, NSError *error)
        {
