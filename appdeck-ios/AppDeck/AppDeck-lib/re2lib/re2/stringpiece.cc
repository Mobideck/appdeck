...
int StringPiece::find(const StringPiece& s, size_type pos) const {
  ...
  return xpos + s.length_ <= static_cast<size_type>((int)length_) ? (int)xpos : (int)npos;
}
