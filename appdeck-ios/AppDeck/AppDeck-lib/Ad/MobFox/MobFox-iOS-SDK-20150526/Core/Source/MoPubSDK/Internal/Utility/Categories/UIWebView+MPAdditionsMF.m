...
NSString *const kJavaScriptDisableDialogSnippetMF = @"window.alert = function() { }; window.prompt = function() { }; window.confirm = function() { };";

@implementation UIWebView (MPAdditionsMF)
...
{
    [self stringByEvaluatingJavaScriptFromString:kJavaScriptDisableDialogSnippetMF];
}
