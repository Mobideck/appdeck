...
@interface MPAdViewMF () <MPBannerAdManagerDelegateMF>

@property (nonatomic, retain) MPBannerAdManagerMF *adManager;
...
- (id)initWithAdUnitId:(NSString *)adUnitId size:(CGSize)size
{
    ...
    if (self = [super initWithFrame:f])
    {
        ...
        self.adManager = [[MPInstanceProviderMF sharedProvider] buildMPBannerAdManagerWithDelegate:self];
    }
    return self;
}
...
{
    if (!self.adContentView || [self.adContentView isKindOfClass:[MRAdViewMF class]]) {
