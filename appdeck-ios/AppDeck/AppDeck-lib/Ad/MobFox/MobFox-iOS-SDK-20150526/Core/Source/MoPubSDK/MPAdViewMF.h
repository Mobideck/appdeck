 ...
 * property to `nil`.
 */
@property (nonatomic, assign) id<MPAdViewDelegateMF> delegate;
...
@protocol MPAdViewDelegateMF <NSObject>
 ...
 * @param view The ad view sending the message.
 */
- (void)willLeaveApplicationFromAd:(MPAdViewMF *)view;
