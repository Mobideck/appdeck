...
@protocol MPInterstitialAdControllerDelegateMF;
...
@interface MPInterstitialAdControllerMF : UIViewController
 ...
 */
@property (nonatomic, assign) id<MPInterstitialAdControllerDelegateMF> delegate;
...
@protocol MPInterstitialAdControllerDelegateMF <NSObject>
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidAppear:(MPInterstitialAdControllerMF *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidDisappear:(MPInterstitialAdControllerMF *)interstitial;
 ...
 * @param interstitial The interstitial ad object sending the message.
 */
- (void)interstitialDidExpire:(MPInterstitialAdControllerMF *)interstitial;
 ...
 */
- (void)dismissInterstitial:(MPInterstitialAdControllerMF *)interstitial __attribute__((deprecated));
