...
@implementation MRPlacementTypePropertyMF : MRPropertyMF

@synthesize placementType = _placementType;

+ (MRPlacementTypePropertyMF *)propertyWithType:(MRAdViewPlacementType)type {
    MRPlacementTypePropertyMF *property = [[[self alloc] init] autorelease];
...
@implementation MRStatePropertyMF

@synthesize state = _state;

+ (MRStatePropertyMF *)propertyWithState:(MRAdViewState)state {
    MRStatePropertyMF *property = [[[self alloc] init] autorelease];
...
@implementation MRScreenSizePropertyMF : MRPropertyMF

@synthesize screenSize = _screenSize;

+ (MRScreenSizePropertyMF *)propertyWithSize:(CGSize)size {
    MRScreenSizePropertyMF *property = [[[self alloc] init] autorelease];
...
@implementation MRSupportsPropertyMF : MRPropertyMF
...
{
    MRSupportsPropertyMF *property = [[[self alloc] init] autorelease];
...
@implementation MRViewablePropertyMF : MRPropertyMF

@synthesize isViewable = _isViewable;

+ (MRViewablePropertyMF *)propertyWithViewable:(BOOL)viewable {
    MRViewablePropertyMF *property = [[[self alloc] init] autorelease];
