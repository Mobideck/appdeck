...
@implementation MRCloseCommandMF

+ (void)load
{
    [MRCommandMF registerCommand:self];
}
...
@implementation MRExpandCommandMF
...
- (BOOL)executeWithParams:(NSDictionary *)params
{
    ...
    MPLogDebugMF(@"Expanding to (%.1f, %.1f, %.1f, %.1f); displaying %@.", x, y, w, h, url);
...
@implementation MRUseCustomCloseCommandMF
...
@implementation MROpenCommandMF
...
@implementation MRCreateCalendarEventCommandMF
...
@implementation MRPlayVideoCommandMF
...
@implementation MRStorePictureCommandMF
