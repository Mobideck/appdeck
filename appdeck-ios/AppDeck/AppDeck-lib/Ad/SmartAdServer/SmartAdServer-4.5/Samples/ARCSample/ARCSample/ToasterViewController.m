...
- (void)dealloc {
	//The toaster is released automatically by ARC but the delegate should be set to nil to prevent crashes during fast navigation in the application.
...
- (void)reload {
	//Do not forget to set the delegate to nil before loosing last reference to the toaster (because the toaster will be automatically released by ARC)
	_toaster.delegate = nil;
