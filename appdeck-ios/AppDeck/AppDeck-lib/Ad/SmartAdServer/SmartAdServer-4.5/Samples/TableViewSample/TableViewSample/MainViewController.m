...
- (void)dealloc {
	//All the banners created must be released properly, delegates must be set to nil to avoid crashes during fast navigation
...
- (SASBannerView *)createBannerViewForCell:(UITableViewCell *)cell formatID:(NSInteger)formatID pageID:(NSString *)pageID master:(BOOL)master target:(NSString *)target {
	...
	SASBannerView *cellBanner = [[SASBannerView alloc] initWithFrame:cell.bounds loader:SASLoaderActivityIndicatorStyleWhite];
