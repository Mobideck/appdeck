...
#import "IMBanner.h"
#import "AppDeckInMobiBannerCustomEvent.h"
...
@interface AppDeckInMobiBannerCustomEvent () <IMBannerDelegate>
...
@implementation AppDeckInMobiBannerCustomEvent
...
{
    MPLogInfo(@"AppDeck Version Requesting InMobi banner");
