...
/**
 * Once the ad fetch has succeeded and the client has finished loading,
 * this will return YES, indicating that the ad is ready to be displayed.
 *
...
/**
 * Attempts to fetch an ad by loading the server url in the web view. 
 */
- (void)fetch;
