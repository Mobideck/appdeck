...
@interface InMobiInterstitialCustomEvent : MPInterstitialCustomEvent
 ...
 * integrating an InMobi interstitial using a MoPub custom event, you must use this method to
