...
#define kSASSDKVersion						@"4.5"
#define kSASSDKRev                          @"3638393234"
...
typedef NS_ENUM(NSInteger, SASLoader) {
	...
	SASLoaderLaunchImage __attribute__((availability(ios,
													 deprecated=4.5,
													 message="This attribute will be removed in the SAS iOS SDK 5.0 and later"))),//"first deprecated in the SAS SDK 4.5 - " = SASLoaderNone,
...
/** *Deprecated* Enables test mode.
 
 Calling this method will enable test mode and display a default ad that always deliver.
 This allows for easier development. Enable test mode in your application:didFinishLaunchingWithOptions: method:
 ...
 @warning Deprecated since iOS Display SDK4.5, please use
 setTestModeEnabled:
 
 @see setTestModeEnabled:
 */

+ (void)enableTestMode __attribute__((availability(ios,
												   deprecated=4.5,
												   message="This method will be removed in the SAS iOS SDK 5.0 and later")));
...
/** *Deprecated* Enables logging mode.
...
+ (void)enableLogging __attribute__((availability(ios,
												  deprecated=4.5,
												  message="This method will be removed in the SAS iOS SDK 5.0 and later")));
...
/** *Deprecated* Initializes and returns a SASAdView object for the given frame, and optionally sets a loader on it.
 ...
 Default loader. The launch image is used for the loader.
 
 SASLoaderActivityIndicatorStyleBlack
 
 Default loader. The loader consists of a black view with a yellow loader.
 
 SASLoaderActivityIndicatorStyleWhite
 
 Default loader. The loader consists of a white view with a yellow loader.
 
 SASLoaderActivityIndicatorStyleTransparent
 
 Default loader. The loader consists of a black semi-transparent view with a yellow loader.
...
/** *Deprecated* Removes the ad interstitial view.
 ...
 @warning Deprecated since iOS Display SDK4.5, please use removeFromSuperview.
...
- (void)displayThisAd:(SASAd *)adv __attribute__((deprecated));
